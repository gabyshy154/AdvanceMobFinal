...
const MissingPoke = () => {
  ...
  // ===== Filter ONLY missing Pokémon + search =====
  useEffect(() => {
    // Missing = not in caughtIds
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Header with avatar + menu + stats + tabs + search */}
      ...
      {/* Content: list of missing Pokémon (or empty state) */}
      {loading ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyContainer}>
              ...
              <Text style={styles.emptyText}>No missing Pokémon</Text>
              <Text style={styles.emptySubtext}>
                You’ve caught them all for now
              </Text>
            </View>
          }
        />
...
// ===== Styles (same as CaughtPoke / HomeScreen) =====
